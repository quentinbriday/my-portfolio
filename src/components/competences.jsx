...
export default class Competences extends Component {
  render() {
    ...
    <hr />
    <br />
    <div className="all-competences">
      <div className="competence-container">
        <span />
        <span />
        <span />
        <span />
        <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="laptop-code" class="svg-inline--fa fa-laptop-code fa-w-20" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
      ...
      <div className="competence-container">
        ...
        <span />
        <span />
        <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="database" class="svg-inline--fa fa-database fa-w-14" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
        ...
        <h1 className="competence-title">Base de données</h1>
		<div className="competences">
			<p>SQL / NoSQL (MongoDB, Neo4j)</p>
		</div>
      </div>
      <div className="competence-container">
        <span />
        ...
        <h1 className="competence-title">Framework</h1>
		<div className="competences">
			<div className="tooltip">Symphony (PHP)<div class="tooltiptext t-right"><ul><li>Framework utilisé lors de mon stage/job étudiant.</li></ul></div></div>
			/ 
